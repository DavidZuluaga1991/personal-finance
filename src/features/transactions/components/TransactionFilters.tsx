    ...
    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
      ...
      <div className="flex flex-col xs:flex-row gap-2 sm:gap-3">
        ...
        <button
          ...
          className="flex-1 xs:flex-none px-3 sm:px-4 py-2 rounded-lg border border-slate-800/80 bg-slate-900/60 text-slate-300 text-xs sm:text-sm font-medium hover:bg-slate-800/60 hover:border-blue-600 transition-colors flex items-center gap-2 justify-center cursor-pointer"
        >
          {sortOrder === 'desc' ? '↓ Desc' : '↑ Asc'}
            ...
            <PermissionGuard permission={Permission.TRANSACTIONS_CREATE}>
              <button
                onClick={onAddClick}
                className="flex-1 xs:flex-none px-3 sm:px-4 py-2 rounded-lg bg-blue-600 hover:bg-blue-700 text-white text-xs sm:text-sm font-medium transition-all duration-200 flex items-center gap-2 justify-center hover:shadow-md hover:shadow-blue-500/30 cursor-pointer"
              >
